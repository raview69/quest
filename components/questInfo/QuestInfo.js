                ...
                <div>
                    <div className="w-[787px]">
                        ...
                        <div className="pt-[40px] w-[694px] text-[#5A5A60]">
                            <p>
                                The quests given by Ant Emicheun seem to depend
                                on class somehow. Level 1 Iop and Sacrier got
                                tofu under the microscope, while a level 1 Cra
                                got Arachnee sandwich. Since Ant is the only one
                                giving elevator quests, this irregularity is
                                probably limited to him only. Will need some
                                testing, though. - Dashiva 23:37, 7 March 2006
                                (UTC)
                            </p>
                            &nbsp;
                            <p>
                                ...
                                its cool or something, its not a quest yet but u
                                fight em for something, u start quest by talking
                                with a lady named sweetness at dofus nighttime.
                                RingWarior
                            </p>
                        </div>
